...
- Fast executer for python codes has been added to make testing new functions faster.
- C# support has been added with different color coding.
- Opening, saving, and writing C# code are all handled.
